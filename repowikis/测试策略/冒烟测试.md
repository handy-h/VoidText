...
## 简介
冒烟测试（Smoke Testing）用于快速验证系统核心功能是否正常工作，确保主要业务流程可以顺畅执行。对于 txtCleaning 项目，冒烟测试覆盖 Web 服务启动、静态资源访问、文件上传与处理、规则管理、审核流程以及版本报告等关键路径，保证每次构建或部署后主干功能可用。
...
- [rules.go:35-86](file://internal/processor/rules/rules.go#L35-L86)
...
**图表来源**
- [run_smoke_tests.sh:69-336](file://testing/smoking_testing/run_smoke_tests.sh#L69-L336)
- [server.go:24-54](file://web/backend/server.go#L24-L54)
...
**图表来源**
- [run_smoke_tests.sh:69-109](file://testing/smoking_testing/run_smoke_tests.sh#L69-L109)
- [server.go:24-26](file://web/backend/server.go#L24-L26)

**章节来源**
- [冒烟测试计划.md:25-32](file://testing/smoking_testing/00-冒烟测试计划.md#L25-L32)
- [run_smoke_tests.sh:69-109](file://testing/smoking_testing/run_smoke_tests.sh#L69-L109)
...
**图表来源**
- [run_smoke_tests.sh:111-175](file://testing/smoking_testing/run_smoke_tests.sh#L111-L175)
- [server.go:30-35](file://web/backend/server.go#L30-L35)

**章节来源**
- [冒烟测试计划.md:33-42](file://testing/smoking_testing/00-冒烟测试计划.md#L33-L42)
- [run_smoke_tests.sh:111-175](file://testing/smoking_testing/run_smoke_tests.sh#L111-L175)
...
**图表来源**
- [run_smoke_tests.sh:177-263](file://testing/smoking_testing/run_smoke_tests.sh#L177-L263)
- [server.go:39-48](file://web/backend/server.go#L39-L48)
- [pipeline.go:104-158](file://internal/processor/pipeline.go#L104-L158)

**章节来源**
- [冒烟测试计划.md:43-62](file://testing/smoking_testing/00-冒烟测试计划.md#L43-L62)
- [run_smoke_tests.sh:177-263](file://testing/smoking_testing/run_smoke_tests.sh#L177-L263)
...
**图表来源**
- [run_smoke_tests.sh:221-249](file://testing/smoking_testing/run_smoke_tests.sh#L221-L249)
- [server.go:51-53](file://web/backend/server.go#L51-L53)
- [rules.go:88-137](file://internal/processor/rules/rules.go#L88-L137)

**章节来源**
- [冒烟测试计划.md:63-72](file://testing/smoking_testing/00-冒烟测试计划.md#L63-L72)
- [run_smoke_tests.sh:221-249](file://testing/smoking_testing/run_smoke_tests.sh#L221-L249)
...
**章节来源**
- [冒烟测试计划.md:73-79](file://testing/smoking_testing/00-冒烟测试计划.md#L73-L79)

### 文件删除
- 删除文件：DELETE /api/files/{md5}

**章节来源**
- [冒烟测试计划.md:80-85](file://testing/smoking_testing/00-冒烟测试计划.md#L80-L85)
- [run_smoke_tests.sh:265-277](file://testing/smoking_testing/run_smoke_tests.sh#L265-L277)
...
**图表来源**
- [run_smoke_tests.sh:1-345](file://testing/smoking_testing/run_smoke_tests.sh#L1-L345)
- [server.go:1-57](file://web/backend/server.go#L1-L57)
- [config.go:1-204](file://internal/config/config.go#L1-L204)
...
## 故障排查指南
常见故障与处理建议：
- 服务无法访问：确认服务已启动（go run ./cmd/txtclean/），检查端口与防火墙
...
## 结论
冒烟测试为 txtCleaning 提供了稳定可靠的快速验证机制，覆盖从服务启动到文件处理、规则管理与审核的完整主干流程。结合单元测试与冒烟测试，可在开发与持续集成阶段快速发现回归问题，保障系统稳定性与交付质量。
...
**章节来源**
- [冒烟测试计划.md:86-96](file://testing/smoking_testing/00-冒烟测试计划.md#L86-L96)
- [sample.txt:1-12](file://testing/smoking_testing/test_data/sample.txt#L1-L12)
...
**章节来源**
- [冒烟测试计划.md:98-129](file://testing/smoking_testing/00-冒烟测试计划.md#L98-L129)
- [run_smoke_tests.sh:1-345](file://testing/smoking_testing/run_smoke_tests.sh#L1-L345)
