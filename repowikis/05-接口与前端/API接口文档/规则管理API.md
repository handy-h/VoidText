...
- [rules.go:28-33](../../internal/processor/rules/rules.go#L28-L33)
- [processor.go:33-34](../../internal/processor/processor.go#L33-L34)
...
**图表来源**
- [rules.go:23-26](../../internal/processor/rules/rules.go#L23-L26)
- [rules.go:13-21](../../internal/processor/rules/rules.go#L13-L21)
...
**图表来源**
- [rules.go:12-19](../../web/backend/handlers/rules.go#L12-L19)
- [rules.go:88-91](../../internal/processor/rules/rules.go#L88-L91)
...
**章节来源**
- [rules.go:12-19](../../web/backend/handlers/rules.go#L12-L19)
- [05-API接口.md:372-399](../../doc/05-API接口.md#L372-L399)
...
**章节来源**
- [rules.go:21-54](../../web/backend/handlers/rules.go#L21-L54)
- [05-API接口.md:401-431](../../doc/05-API接口.md#L401-L431)
...
**章节来源**
- [rules.go:56-68](../../web/backend/handlers/rules.go#L56-L68)
...
**章节来源**
- [rules.go:140-149](../../internal/processor/rules/rules.go#L140-L149)
...
**图表来源**
- [rules.go:103-115](../../internal/processor/rules/rules.go#L103-L115)
...
**图表来源**
- [rules.go:32-35](../../web/backend/handlers/rules.go#L32-L35)
- [rules.go:143-147](../../internal/processor/rules/rules.go#L143-L147)
...
**图表来源**
- [processor.go:98-108](../../internal/processor/processor.go#L98-L108)
...
**图表来源**
- [rules.go:177-187](../../internal/processor/rules/rules.go#L177-L187)
...
**图表来源**
- [server.go:3-10](../../web/backend/server.go#L3-L10)
- [rules.go:3-11](../../internal/processor/rules/rules.go#L3-L11)
...
**章节来源**
- [rules.go:48-51](../../web/backend/handlers/rules.go#L48-L51)
- [rules.go:129-136](../../internal/processor/rules/rules.go#L129-L136)
