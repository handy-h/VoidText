...
## 简介
本文件聚焦VoidText系统中三个专门用途的高级表：chunk_repair_cache（块级修复缓存表）、retry_queue（重试队列表）与prompt_versions（提示词版本表）。我们将从设计目的、业务场景、技术实现、幂等性与断点续传机制、故障处理与自动重试、提示词版本管理与Evolver自进化、索引与查询优化、使用示例与最佳实践等方面进行系统化阐述，并配合可视化图表帮助理解。
...
- [db.go:141-187](../internal/database/db.go#L141-L187)

章节来源
- [chunk_cache_repo.go:57-65](../internal/database/chunk_cache_repo.go#L57-L65)
- [db.go:89-222](../internal/database/db.go#L89-L222)
- [03-数据库设计.md:94-162](../doc/03-数据库设计.md#L94-L162)
...
- [evolver_monitor.go:18-41](../internal/processor/evolver_monitor.go#L18-L41)
- [model_repairer.go:526-563](../internal/processor/model_repairer.go#L526-L563)
...
- [chunk_cache_repo.go:69-100](../internal/database/chunk_cache_repo.go#L69-L100)
- [prompt_manager.go:177-182](../internal/processor/prompt_manager.go#L177-L182)
...
图表来源
- [db.go:142-155](../internal/database/db.go#L142-L155)
- [03-数据库设计.md:94-116](../doc/03-数据库设计.md#L94-L116)

章节来源
- [chunk_cache_repo.go:69-100](../internal/database/chunk_cache_repo.go#L69-L100)
- [chunk_cache_repo.go:105-137](../internal/database/chunk_cache_repo.go#L105-L137)
- [chunk_cache_repo.go:139-167](../internal/database/chunk_cache_repo.go#L139-L167)
- [chunk_cache_repo.go:392-420](../internal/database/chunk_cache_repo.go#L392-L420)
- [chunk_cache_repo.go:425-478](../internal/database/chunk_cache_repo.go#L425-L478)
...
图表来源
- [db.go:157-172](../internal/database/db.go#L157-L172)
- [03-数据库设计.md:117-141](../doc/03-数据库设计.md#L117-L141)

章节来源
- [chunk_cache_repo.go:169-202](../internal/database/chunk_cache_repo.go#L169-L202)
- [chunk_cache_repo.go:207-250](../internal/database/chunk_cache_repo.go#L207-L250)
...
图表来源
- [db.go:174-187](../internal/database/db.go#L174-L187)
- [03-数据库设计.md:142-162](../doc/03-数据库设计.md#L142-L162)

章节来源
- [chunk_cache_repo.go:277-301](../internal/database/chunk_cache_repo.go#L277-L301)
- [chunk_cache_repo.go:306-344](../internal/database/chunk_cache_repo.go#L306-L344)
...
- [chunk_cache_repo.go:277-301](../internal/database/chunk_cache_repo.go#L277-L301)
- [evolver.py:32-168](../scripts/evolver.py#L32-L168)

章节来源
- [prompt_manager.go:15-76](../internal/processor/prompt_manager.go#L15-L76)
- [prompt_manager.go:308-322](../internal/processor/prompt_manager.go#L308-L322)
- [prompt_manager.go:324-353](../internal/processor/prompt_manager.go#L324-L353)
- [evolver_monitor.go:117-177](../internal/processor/evolver_monitor.go#L117-L177)
- [evolver_monitor.go:179-285](../internal/processor/evolver_monitor.go#L179-L285)
- [evolver.py:143-211](../scripts/evolver.py#L143-L211)
...
章节来源
- [db.go:196-202](../internal/database/db.go#L196-L202)
- [03-数据库设计.md:112-162](../doc/03-数据库设计.md#L112-L162)
